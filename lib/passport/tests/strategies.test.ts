...
describe('verifyUserLogin', () => {
    ...
    it('should error if user credentials is invalid', async () => {
        ...
        await verifyUserLogin(req, testUser.username, testUser.password, doneCb)(returnEmptyUser, validCode, sendTwoFactorEmail);
        await verifyUserLogin(req, 'InvalidUser', 'password', doneCb)(returnNullUser, validCode, sendTwoFactorEmail);
    ...
    it('should send new 2FA code if previous code expired', async () => {
        ...
        await verifyUserLogin(req, 'ValidUser', 'password', doneCb)(authenticateExpiredUser, invalidCode, sendTwoFactorEmail);
        expect(doneCb).toHaveBeenCalled();
    ...
    it('should send new 2FA code if invalid code provided', async () => {
        ...
        await verifyUserLogin(req, 'ValidUser', 'password', doneCb)(authenticateValidUser, invalidCode, sendTwoFactorEmail);
    ...
    it('should handle correct 2FA code entered', async () => {
        ...
        await verifyUserLogin(req, 'ValidUser', 'password', doneCb)(authenticateValidUser, validCode, sendTwoFactorEmail);
